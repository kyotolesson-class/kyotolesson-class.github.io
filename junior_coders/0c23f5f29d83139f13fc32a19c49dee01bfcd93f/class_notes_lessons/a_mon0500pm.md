...
Haunted House
  : One limitation of Tynker is that it only allows one to work in 2-D. One studnen and I havd a long talk about how create a more 3-D effect. This was  agreat conversation as it really helps to understand what can and can't be done, and how to use what you can do in creative ways. For example, Tynker has a tiling feature that allows characters to move smoothly in a plane, but not "in or out" of the plane. However, if you imagine that this flat plane is curved around in a circle, you can create the effect 
...
![create deck](https://i.imgur.com/QVVXvgr.png)
{: .jsgif}
...
![platform selector](https://www.tynker.com/ide/imgs/template-tags/web/level-editor-tiles-selector.png)
{: width="100px"  .jsgif }


![platform selector](https://www.tynker.com/ide/imgs/template-tags/web/level-editor-tiles-choices.png)
{: width="100px"  .jsgif }
