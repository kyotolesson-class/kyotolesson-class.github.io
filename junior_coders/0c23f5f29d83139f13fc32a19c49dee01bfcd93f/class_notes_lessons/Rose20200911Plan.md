...
{% include niceimage-galleryNoTableweserveGifsNoLink.html folder="/images/2020-09-04/" %}
...
The homework is to make a longer conversation by sending several messages back and forth between characters as above. If you need something for the characters to say, [here are some jokes](../lessons/JokesForBadJokes.html) to use.
